...
particleArrayInd = simul.input.particles.singleParticleArrayIndex;
for p=0:2*lmax
                    ...
                    for l2=1:lmax
                        for m2=-l2:l2
                            if abs(m1-m2)<=p
                                ...
                                mieCoeff = simul.tables.mieCoefficients(particleArrayInd(spherArr(:)),n1,:);
                                plm = Plm{p+1,abs(m1-m2)+1};
