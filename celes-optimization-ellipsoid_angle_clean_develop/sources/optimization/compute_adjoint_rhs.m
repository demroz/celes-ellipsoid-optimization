function adjointRightHandSide = compute_adjoint_rhs(simulation,inputDerivative,points)
...
adjointRightHandSide = simulation.numerics.deviceArray(zeros(particleNumber,expansionDegree,'single'));
    ...
    for l=1:simulation.numerics.lmax
        ...
        for m=-l:l
            ...
            for tau=1:2
                ...
                adjointRightHandSide(jS,n) = sum(sum(inputDerivative.*N));
            end
        end
    end
end